...
foreach($result as $row)
{
	...
	$sub_array[] = $status;
	$sub_array[] = '<button type="button" name="view" id="'.$row["product_id"].'" class="btn btn-danger btn-xs view">View</button>';
	$sub_array[] = '<button type="button" name="update" id="'.$row["product_id"].'" class="btn btn-warning btn-xs update">Update</button>';
	$sub_array[] = '<button type="button" name="stchange" id="'.$row["product_id"].'" class="btn btn-primary btn-xs stchange" data-status="'.$row["product_status"].'">Change Status</button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["product_id"].'" class="btn btn-info btn-xs delete">Delete</button>';
	$data[] = $sub_array;
}
