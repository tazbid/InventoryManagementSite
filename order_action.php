...
if(isset($_POST['btn_action']))
{
	...
	{
		$query = "DELETE inventory_order, inventory_order_product FROM inventory_order INNER JOIN inventory_order_product WHERE inventory_order.inventory_order_id = inventory_order_product.inventory_order_id AND inventory_order.inventory_order_id = :inventory_order_id ";
		$statement = $connect->prepare($query);
		$statement->execute(
			array(
				':inventory_order_id'   => $_POST["inventory_order_id"]
