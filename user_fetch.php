...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="stchange" id="'.$row["user_id"].'" class="btn btn-primary btn-xs stchange" data-status="'.$row["user_status"].'">Change Status</button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["user_id"].'" class="btn btn-info btn-xs delete">Delete</button>';
	$data[] = $sub_array;
}
