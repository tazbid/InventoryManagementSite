...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="stchange" id="'.$row["inventory_order_id"].'" class="btn btn-primary btn-xs stchange" data-status="'.$row["inventory_order_status"].'">Change Status</button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["inventory_order_id"].'" class="btn btn-danger btn-xs delete">Delete</button>';
	$data[] = $sub_array;
}
